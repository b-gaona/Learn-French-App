...
public class PanelSegundoGrupo extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        etiquetaTitulo.setText("Verbes du deuxième groupe");
        ...
        javax.swing.ImageIcon gifCelebration = new javax.swing.ImageIcon(getClass().getResource("/imagenes/conjugacionSegundoGrupo.png"));
    ...
    private void botonInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonInfoActionPerformed
        JOptionPane.showMessageDialog(null, " El segundo grupo consta de los verbos cuyo infinitivo \n termine en -ir y cuyo participio presente termine en \n -issant.\n"
                + "\n A los dos primeros grupos se les conoce como \n verbos regulares ya que pueden ser conjugados \n siguiendo una serie de reglas relativamente\n uniformes.", "Informacion", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void agregarInformacionALosCampos() {
        ...
        if (opcion1 == true) {
            if (contPregunta <= 15) { //SIEMPRE Y CUANDO EL NUMERO NO SUPERE 15
                insertarPrimerCampo.setText(v2.generarRandom2()); //FRANCES
            }
        }
        //Si es seleccionado ESPAÑOL
        if (opcion2 == true) {
            if (contPregunta <= 15) { //SIEMPRE Y CUANDO EL NUMERO NO SUPERE 15
                insertarPrimerCampo.setText(v2.generarRandom22()); //ESPAÑOL 
            }
        }
