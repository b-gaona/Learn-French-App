...
public class PanelPrimerGrupo extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        etiquetaTitulo.setText("Verbes du premier groupe");
        ...
        javax.swing.ImageIcon gifCelebration = new javax.swing.ImageIcon(getClass().getResource("/imagenes/premierGroupe.jpg"));
    ...
    private void botonInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonInfoActionPerformed
        JOptionPane.showMessageDialog(null, " El primer grupo consta de los verbos terminados \n en -er exceptuando el verbo aller.\n"
    ...
    private void agregarInformacionALosCampos() {
        ...
        if (opcion1) {
            if (contPregunta <= 15) { //SIEMPRE Y CUANDO EL NUMERO NO SUPERE 15
                insertarPrimerCampo.setText(v2.generarRandom1()); //FRANCES
            }
        }
        //Si es seleccionado ESPAÑOL
        if (opcion2) {
            if (contPregunta <= 15) { //SIEMPRE Y CUANDO EL NUMERO NO SUPERE 15
                insertarPrimerCampo.setText(v2.generarRandom11()); //ESPAÑOL 
            }
        }
